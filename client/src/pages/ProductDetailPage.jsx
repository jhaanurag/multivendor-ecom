...
const ProductDetailPage = () => {
    ...
    const { isAuthenticated, user, login } = useAuth(); // Assuming login or a way to refresh user context is available or we trigger a refetch
    ...
    const handleWishlist = async () => {
        ...
        try {
            ...
            setNotification(updatedWishlist.includes(product._id) ? 'Added to wishlist' : 'Removed from wishlist');
            setTimeout(() => setNotification(null), 3000);
            
            // Note: Ideally we should update the global auth context here
            // but for now local state gives immediate feedback
        } catch (err) {
